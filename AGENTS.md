...
Naming: **LOKI** is the code name and **OTTO** is the product name — **interchangeable** (either is acceptable). "Otto Software and Tools" is registered with the USPTO under **Monster Gaming AI, Inc.**
